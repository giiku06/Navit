...
import com.example.giiku06application.databinding.NewAppWidgetConfigureBinding;
...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.example.giiku06application.NewAppWidget";
